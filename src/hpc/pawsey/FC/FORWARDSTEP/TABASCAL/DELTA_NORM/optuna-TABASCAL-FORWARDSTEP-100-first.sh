#!/bin/bash
#SBATCH --job-name=SNN-SUPER-FC_FORWARD_STEP-FORWARDSTEP-TABASCAL
#SBATCH --nodes=8
...
export STUDY_NAME="SNN-SUPER-B-${DATASET}-${ENCODER_METHOD}-${MODEL_TYPE}-100-${NUM_HIDDEN}-${FORWARD_EXPOSURE}-${DELTA_NORMALIZATION}"
