#!/bin/bash
#SBATCH --job-name=SNN-SUPER-FC_FORWARD_STEP-FORWARDSTEP-LOFAR
#SBATCH --nodes=1
...
export STUDY_NAME="SNN-SUPER-C-${DATASET}-${ENCODER_METHOD}-${MODEL_TYPE}-5.6-${NUM_HIDDEN}-${FORWARD_EXPOSURE}-${DELTA_NORMALIZATION}"
