#!/bin/bash
#SBATCH --job-name=SNN-SUPER-FC_DELTA_EXPOSURE-DELTA_EXPOSURE-TABASCAL-128
#SBATCH --nodes=8
...
export STUDY_NAME="SNN-SUPER-${DATASET}-${ENCODER_METHOD}-${MODEL_TYPE}-100-${NUM_HIDDEN}-${FORWARD_EXPOSURE}"
