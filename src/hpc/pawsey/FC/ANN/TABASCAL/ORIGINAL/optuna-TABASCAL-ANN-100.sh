#!/bin/bash
#SBATCH --job-name=SNN-SUPER-FC_ANN-ANN-TABASCAL
#SBATCH --nodes=1
...
export LIMIT="1.0"
export MODEL_TYPE="FC_ANN"
export ENCODER_METHOD="ANN"
...
export STUDY_NAME="SNN-SUPER-B-${DATASET}-${ENCODER_METHOD}-${MODEL_TYPE}-100-${NUM_HIDDEN}-${DELTA_NORMALIZATION}"
