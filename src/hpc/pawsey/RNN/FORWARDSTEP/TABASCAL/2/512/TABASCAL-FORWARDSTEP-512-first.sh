#!/bin/bash
#SBATCH --job-name=SNN-SUPER-RNN_FORWARD_STEP-FORWARDSTEP-TABASCAL-512
#SBATCH --nodes=8
...
export OUTPUT_DIR="/scratch/pawsey0411/npritchard/outputs/snn-super/${MODEL_TYPE}/${ENCODER_METHOD}/${DATASET}/${NUM_LAYERS}/${NUM_HIDDEN}/${LIMIT}/${FORWARD_EXPOSURE}"
